        ...
        {!submitted ? (
              ...
              <>
                ...
                {emailError && (
                  <p className="text-red-500 text-sm mt-1">
                    No hay ningún registro con este correo
                  </p>
                )}
                <button
                  onClick={handleSend}
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="flex items-center gap-2 text-green-800 underline hover:text-green-600 mt-4"
            >
